...
class GroceriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create grocery" do
    assert_difference('Grocery.count') do
      post groceries_url, params: { grocery: { grocery: @grocery.grocery, quantity: @grocery.quantity } }, as: :json
    end
  ...
  test "should update grocery" do
    patch grocery_url(@grocery), params: { grocery: { grocery: @grocery.grocery, quantity: @grocery.quantity } }, as: :json
    assert_response 200
  end
